...
namespace Test
{
    public class TestMovement : MonoBehaviour
    {
        ...
        [Header("Audio")] [SerializeField] private AudioClip _matchAudioClip;
        ...
        public List<ISelectable> EmptySelectables
        {
            get => _emptySelectables;
            set => _emptySelectables = value;
        }
        ...
        private void ClickOnCube(ISelectable selectable)
        {
            ...
            switch (_currentSelectable)
            {
                case null when _selection.MeshRenderer.enabled:
                    ...
                    switch (_testGrid.isTutorialFinished)
                    {
                        case false when !TestGrid.IsFirstClicked &&
                                        _currentSelectable.ColorTypeTransform.position == new Vector3(0, 1, 0):
                            OnTutorialCubeClick?.Invoke();
                            break;
                        case false when !TestGrid.IsThirdClicked &&
                                        _currentSelectable.ColorTypeTransform.position == new Vector3(1, 0, 0):
                ...
                case {IsSelected: true}:
                {
                    ...
                    _currentSelectable.SelectDeselect();
                    ...
                    switch (_testGrid.isTutorialFinished)
                    {
                        case false when !TestGrid.IsSecondClicked &&
                                        _secondSelectable.ColorTypeTransform.position == new Vector3(1, 1, 0):
        ...
        private IEnumerator MoveCubeCo(Vector3 secondPosition)
        {
            ...
            {
                IsMoving = true;
                _currentSelectable.ColorTypeTransform.position =
                    Vector3.Lerp(startPosition, secondPosition, timeElapsed / _movementDuration);
        ...
        private void SetLayerMask()
        {
            ...
            {
                foreach (var emptySelectable in _emptySelectables.Where(emptySelectable =>
                             emptySelectable.ColorTypeTransform != null))
                {
        ...
        private void MergeCubes(ISelectable cube1, ISelectable cube2)
        {
            ...
            cube1.EmptyCubeLineRenderer.enabled = true;
            cube2.EmptyCubeLineRenderer.enabled = true;
        ...
        private void CheckSelectablesBetweenCurrentAndSecond()
        {
            ...
            {
                _cubeHit = cube.collider.GetComponent<Cube>();
            ...
            _currentSelectable.EmptyCubeLineRenderer.enabled = true;
